...
const { frameRef, last30_framesAverageLatency, last1s_framesFPS } = storeToRefs(useTrainStore())
...
const {
  ...
  toggleFullScreen,
  handleFrame
} = useVideoPanel(videoCanvas, { latencyRef: last30_framesAverageLatency, fpsRef: last1s_framesFPS })
