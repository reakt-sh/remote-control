...
docker run -d \
  ...
  -p 8084:8084 \
  -p 8883:8883 \
  -v /etc/letsencrypt/archive/wt.rtsys-lab.de/fullchain5.pem:/etc/fullchain1.pem \
  -v /etc/letsencrypt/archive/wt.rtsys-lab.de/chain5.pem:/etc/chain1.pem \
  -v /etc/letsencrypt/archive/wt.rtsys-lab.de/privkey5.pem:/etc/privkey1.pem \
