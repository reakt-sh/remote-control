...
#         --ignore-certificate-errors-spki-list=Gi/HIwdiMcPZo2KBjnstF5kQdLI5bPrYJ8i3Vi6Ybck=
            ...
            # --ignore-certificate-errors-spki-list=T2Wl3QTmaFHwKF8yLXZDrLqyao7Y898TJvLkr5Fe5A0=
#
...
class WebTransportProtocol(QuicConnectionProtocol):
    ...
    def quic_event_received(self, event: QuicEvent) -> None:
        print(f"QUIC: Received event: {event}")
...
if __name__ == '__main__':
    ...
    print("Loading certificate and key: {} {}".format(args.certificate, args.key))
